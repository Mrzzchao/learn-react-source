  ...
  if (firstEffect !== null) {
    ...
    do {
      if (__DEV__) {
        ...
        try {
          // 渲染阶段：before mutation阶段（执行DOM操作前）
...
/**
 * 提交操作
 * @param {*} root 提交fiber节点
 * @param {*} renderPriorityLevel 渲染优先级
 */
